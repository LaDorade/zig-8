...
const sleep_ms = @import("utils.zig").sleep_ms;
...
pub fn loop(cpu: *zig8.CPU, running: *std.atomic.Value(bool)) !void {
    // tty gestion
    ...
    const display_period_ms = std.time.ms_per_s / cpu.display_freq_hz;
